...
{
    private const string ConfigName = "woopdiscord.json";
    ...
    public override void Start(ICoreAPI api)
    {
        ...
        // "condition": { "when": "woopdiscord_ExampleProperty", "isValue": "true" }
        api.World.Config.SetBool("woopdiscord_ExampleProperty", Config.ExampleConfigSetting);
    }
}